...
<head>
    ...
    <link rel="icon" type="image/x-png" href="{{ asset('assets_landing') }}/favicon.png" />
...
<body style="background-color: #f4f4f4; margin: 0 !important; padding: 0 !important;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <!-- LOGO -->
        <tr>
            <td style="background: linear-gradient(45deg, #2937f0, #9f1ae2) !important;" align="center">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top"
                            ...
                            <img src="{{ asset('smk.png') }}" width="125" height="120"
                                ...
                                <tr>
                                    <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 60px 30px;">
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center"
                                                    style="border-radius: 3px;background: linear-gradient(45deg, #2937f0, #9f1ae2) !important;">
                                                    <a href="{{ $link }}" target="_blank"
                                                        style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 15px 25px; border-radius: 2px; border: 1px solid linear-gradient(45deg, #2937f0, #9f1ae2) !important; display: inline-block;">Confirm
                                                        Account</a>
                                                </td>
                                            </tr>
                                        </table>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;"><a href="#" target="_blank"
                                    style="color: linear-gradient(45deg, #2937f0, #9f1ae2) !important;">{{ $link }}</a>
                            </p>
                        </td>
                    </tr>
                    <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#FFECD1" align="center"
                            ...
                            <p style="margin: 0; color: linear-gradient(45deg, #2937f0, #9f1ae2) !important;">
                                We&rsquo;re here
                                to help you out</p>
                        </td>
                    </tr>
