        ...
        <x-backend.card>
            ...
            <x-slot name="body">
                <div x-data="{ userType: '{{ $model::TYPE_USER }}' }">
                    ...
                    <!--form-group-->
                    <div class="form-group row">
                        <label for="name" class="col-md-2 col-form-label">Provider</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row">
                        <label for="password_confirmation" class="col-md-2 col-form-label">@lang('Password
                            Confirmation')</label>
                    ...
                    <div x-data="{ emailVerified: false }">
                        ...
                        <div x-show="!emailVerified">
                            <div class="form-group row">
                                <label for="send_confirmation_email" class="col-md-2 col-form-label">@lang('Send
                                    Confirmation E-mail')</label>
