                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="location" class="form-control" placeholder="{{ __('Lokasi') }}"
                            value="{{ old('location') ?? $data->location }}" maxlength="200" required />
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="host" class="form-control" placeholder="{{ __('Tuan Rumah') }}"
                            value="{{ old('host') ?? $data->host }}" maxlength="200" required />
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <input type="text" autocomplete="off" name="date_from" class="form-control datepicker"
                            placeholder="{{ __('Acara mulai') }}"
                            value="{{ old('date_from') ?? date('d-m-Y', strtotime($data->date_from)) }}" maxlength="200"
                            required />
                    </div>
                    ...
                    <div class="col-md-3">
                        <input type="text" autocomplete="off" name="date_end" class="form-control datepicker"
                            placeholder="{{ __('Acara selesai') }}"
                            value="{{ old('date_end') ?? date('d-m-Y', strtotime($data->date_end)) }}" maxlength="200"
                            required />
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="certificate_link" class="form-control"
                            placeholder="{{ __('Link Sertifikat') }}"
                            value="{{ old('certificate_link') ?? $data->certificate_link }}" maxlength="200" />
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="register_link" class="form-control"
                            placeholder="{{ __('Link Daftar') }}"
                            value="{{ old('register_link') ?? $data->register_link }}" maxlength="200" />
                    </div>
                </div>
                <div class="form-group row">
